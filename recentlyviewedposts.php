...
function recently_viewed_posts( $max_shown = 5 ) {
	...
	if ( $html && ( $html != "" ) ) {
		echo '<div class="recently-viewed-posts"><h3 class="recently-viewed-posts-header">' . __( 'What others are reading right now' ) . '</h3><div class="recently-viewed-posts-list"><ul class="recently-viewed-posts-list">';
		echo $html;
		echo "</ul></div></div>";
	}
}
